...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=None,
                        help="JSON 实验配置文件。")
    parser.add_argument("--run-name", type=str, default="grpo_run",
                        help="本次训练的名称。")
    ...
    parser.add_argument("--norm-adv-by-std", action="store_true", default=True)
    parser.add_argument("--no-norm-adv", dest="norm_adv_by_std", action="store_false",
...
def main() -> None:
    ...
    cfg = GRPOConfig(
        ...
        resume_from_checkpoint=_resolve_path(args.resume_from_checkpoint, WORKSPACE_ROOT),
        lora_r=args.lora_r,
        ...
        norm_adv_by_std=args.norm_adv_by_std,
